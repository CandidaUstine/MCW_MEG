% freq = 'beta'
% subj = 'EP8'
% P = dlmread(strcat('/home/custine/MEG/data/epi_conn/', subj, '/coh/', subj, '_', freq, '_powEnv_LabelsMatrix.txt'));
% R = corrcoef(P'); 
% dlmwrite(strcat('/home/custine/MEG/data/epi_conn/', subj, '/coh/', subj, '_',freq, '_powEnv-Corr_LabelsMatrix.txt'), R, 'delimiter', ' ')
% 
