...
EP5c = dlmread(strcat('/home/custine/MEG/data/epi_conn/EP5/coh/EP5_', freq, '_CRM-noise_powEnv-Corr_LabelsMatrix.txt'));
EP6c = dlmread(strcat('/home/custine/MEG/data/epi_conn/EP6/coh/EP6_', freq, '_CRM-noise_powEnv-Corr_LabelsMatrix.txt'));
EP5d = dlmread(strcat('/home/custine/MEG/data/epi_conn/EP5/coh/EP5_', freq, '_DFNAM-noise_powEnv-Corr_LabelsMatrix.txt'));
EP6d = dlmread(strcat('/home/custine/MEG/data/epi_conn/EP6/coh/EP6_', freq, '_DFNAM-noise_powEnv-Corr_LabelsMatrix.txt'));
...
for i = [9, 17, 31, 35, 61, 65, 67, 10 18,32, 36, 62, 66, 68]
    ...
    for j = [9, 17, 31, 35, 61, 65, 67, 10 18,32, 36, 62, 66, 68]
        EP1_t = [EP1_t, EP5c(i,j)];
        EP3_t = [EP3_t, EP5d(i,j)];
        EP5_t = [EP5_t, EP6c(i,j)];
        EP7_t = [EP7_t, EP6d(i,j)];

        EP4_t = [EP4_t, EP4(i,j)];
        EP6_t = [EP6_t, EP6(i,j)];
        EP8_t = [EP8_t, EP8(i,j)];
        EP10_t = [EP10_t, EP10(i,j)];        
    end
