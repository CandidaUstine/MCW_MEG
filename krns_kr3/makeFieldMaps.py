...
evoked_fname = data_path + 'ave_projon/9367_s5_Word_All-ave.fif'
...
evoked.save('/home/custine/MEG/data/krns_kr3/9367/s5/results/fieldmaps/9367_s5_Word_All-'+'-'+str(args.time1)+'-'+str(args.time2)+'-ave.fif')
