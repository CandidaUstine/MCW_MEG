...
@author: custine
Usage: python preProc_avg.py subjID sessID run
Example: python preProc_avg.py 9511 s1 run1
"""
...
runs = cc.runDict[runID]
labelList = cc.condLabels[runID]
event_id = {}
condName = {}
...
for run in runs:
        ...
        event_file = data_path + '/eve/' + subjID + '_'+ sessID +'_'+runID + evSuffix
       ## event_file = data_path + '/ssp/fieldtrip/' + subjID + '_' + par + run + '_clean_comp_raw-eve.fif' #Reading fiff after Fieldtrip ICA analysis 
        ...
        fiff.write_evoked(data_path + '/ave_projon/'+subjID+'_' + sessID+'_'+runID+'-ave.fif', evoked)
