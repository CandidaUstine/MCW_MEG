function preProc_project_allC_FT(exp, subjID, sessID, run)
...
comp_file = strcat(inpath,'ssp/fieldtrip/', subjID,'_',run,'_allC_comp.mat')
...
% %For the whole time window of the raw file 
F = F'
[len, ~] = size(F);
begS = F(1,1)
endS = F(len,1)
